...
<head>
 ...
 <meta charset="utf-8">
    ...
    <title>Create your Space | Mango</title>
...
<header>
  ...
  <div class=" p-md-5 mb-4 text-white rounded bg-dark">
    <div class="col-md-6 px-0">
      <h1 class="display-4 fst-italic">Create your Space™. <br/> This is Mango.</h1>
      <p class="lead my-3">The idea behind Mango’s is to create a space for every person. Our engine is designed to create a world where every person feels included in something that is purposeful, vibrant and organic.</p>
    ...
    <div class="col-md-6">
      <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
        <div class="col p-4 d-flex flex-column position-static">
          ...
          <p class="card-text mb-auto">What would you have in your space? We want our users to feel like they can use their voice and not just be heard but be understood.</p>
    ...
    <div class="col-md-6">
      <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
        <div class="col p-4 d-flex flex-column position-static">
          ...
          <h3 class="mb-0">The HOW-TOs</h3>
          <div class="mb-1 text-muted">Nov 11</div>
          <p class="mb-auto">Mango is free, join and start creating this new sense of social connectivity through their posts, songs, books, pictures, videos and other contents.</p>
          <a href="#" class="stretched-link">Continue reading</a>
        </div>
        <div class="col-auto d-none d-lg-block">
          <svg class="bd-placeholder-img" width="200" height="250" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#55595c"/><text x="50%" y="50%" fill="#eceeef" dy=".3em">Thumbnail</text></svg>
  ...
  <div class="row g-5">
    <div class="col-md-8">
      ...
      <article class="blog-post">
        <h2 class="blog-post-title">Create your Space™</h2>
